...
//             }
//
//             encrypted = RsaAlgorithm.EncryptBytes(unencrypted, public_);
//
//             //Adding to list.
...
//         for (int i = 0; i < chunks; i++)
//         {
//             decryptedList.Add(RsaAlgorithm.DecryptBytes(byteChunks[i], private_));
//         }
//
...
//     [DataMember] public int chunkModulus;
//     [DataMember] public int initialByteLength;
//     [DataMember] public int chunks;
//     [DataMember] public int maxChunkLength;
//     [DataMember] public List<byte[]> byteChunks = new List<byte[]>();
// }